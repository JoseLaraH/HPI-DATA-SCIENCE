...
# Desanidar y transformar columnas
...
# Verificar y desanidar la columna 'cast'
if 'cast' in credits_df.columns:
    credits_df['cast'] = credits_df['cast'].fillna('[]').apply(ast.literal_eval)
else:
    print("La columna 'cast' no existe en credits_df")

# Continuar con las transformaciones necesarias en credits_df
...
# Aquí puedes añadir el resto de transformaciones o procesamiento que necesites

# Puedes agregar un endpoint de ejemplo si necesitas interactuar con los datos mediante FastAPI
@app.get("/")
def read_root():
